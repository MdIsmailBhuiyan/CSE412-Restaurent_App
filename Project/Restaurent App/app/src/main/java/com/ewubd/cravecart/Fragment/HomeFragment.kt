...
import com.ewubd.cravecart.adapter.popularAdapter
import com.ewubd.cravecart.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val foodName = listOf("Cookies","Set Menu", "Ice Cream","Soup")
        val Price = listOf("BDT 50","BDT 70", "BDT 80", "BDT 10")
